...
class LetterEventsEndpoint extends ResourceEndpoint
{
        ...
        return new LetterEventCollection(
            $this
                ->performGetCollectionRequest(
                    sprintf('/organisations/%s/deliveries/letters/%s/events', $this->getOrganisationId(), $this->getLetterId()),
    ...
    public function getSentCollection(?LetterEventCollectionParameterBag $letterEventCollectionParameterBag = null): LetterEventCollection
    {
        return new LetterEventCollection(
            $this
                ->performGetCollectionRequest(
                    sprintf('/organisations/%s/deliveries/letters/events/sent', $this->getOrganisationId()),
                    $letterEventCollectionParameterBag ?? (new LetterEventCollectionParameterBag())
                )->json()
        );
    }
    ...
    public function getUndeliverableCollection(?LetterEventCollectionParameterBag $letterEventCollectionParameterBag = null): LetterEventCollection
    {
        return new LetterEventCollection(
            $this
                ->performGetCollectionRequest(
                    sprintf('/organisations/%s/deliveries/letters/events/undeliverable', $this->getOrganisationId()),
                    $letterEventCollectionParameterBag ?? (new LetterEventCollectionParameterBag())
                )->json()
        );
    }
    ...
    public function getDeliveredCollection(?LetterEventCollectionParameterBag $letterEventCollectionParameterBag = null): LetterEventCollection
    {
        return new LetterEventCollection(
            $this
                ->performGetCollectionRequest(
                    sprintf('/organisations/%s/deliveries/letters/events/delivered', $this->getOrganisationId()),
                    $letterEventCollectionParameterBag ?? (new LetterEventCollectionParameterBag())
                )->json()
        );
    }
